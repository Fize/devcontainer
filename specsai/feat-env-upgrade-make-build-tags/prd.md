...
**功能领域5：Node.js 24 LTS 支持**
- **业务价值**：满足使用 Node.js 的开发者需求，支持 LTS 版本以提升稳定性与可维护性。
- **关键用户故事**：
  作为前端/全栈工程师，我需要在容器内直接使用 Node.js 24 LTS 进行开发与构建，以便快速启动项目并保持与生产一致的运行时版本。
- **验收标准**：
  - 提供包含 Node.js 24 LTS 的镜像变体或能力。
  - 在容器内可验证 Node.js 版本为 24 LTS，满足基础开发与构建场景。
  - 镜像标识/标签能体现该能力，便于选择与分发。
